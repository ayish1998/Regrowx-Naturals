...
import { MessageCircle, X, Send, Leaf, Brain, Package, HelpCircle } from 'lucide-react'
...
export default function SimpleChatWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Chat Interface */}
      {isOpen && (
        <div className="mb-4 h-96 md:h-[500px] w-80 md:w-96 transition-all duration-300 ease-in-out">
